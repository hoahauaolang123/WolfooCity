    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Piranha_SiteContacts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Piranha_SiteContacts_Piranha_Sites_SiteId",
                        column: x => x.SiteId,
                        principalTable: "Piranha_Sites",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
           ...
           migrationBuilder.CreateIndex(
               name: "IX_Piranha_SiteContacts_SiteId",
               table: "Piranha_SiteContacts",
               column: "SiteId");
        }
