...
namespace Piranha
{
    public abstract class Db<T> : DbContext, IDb where T : Db<T>
    {
        ...
        public DbSet<Data.SiteContact> SiteContacts { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder mb)
        {
            ...
            mb.Entity<Data.SiteContact>().ToTable("Piranha_SiteContacts");
            mb.Entity<Data.SiteContact>().Property(c => c.UserId).HasMaxLength(128);
            mb.Entity<Data.SiteContact>().Property(c => c.Author).HasMaxLength(128).IsRequired();
            mb.Entity<Data.SiteContact>().Property(c => c.Email).HasMaxLength(128).IsRequired();
            mb.Entity<Data.SiteContact>().Property(c => c.Url).HasMaxLength(256);
